        ...
        <div class="sm:grid grid-cols-3">
            ...
            <div class="text-lg col-span-2">
                ...
                <ul class="mb-6 list-disc pl-8">
                    ...
                    <li>Enrichir <NuxtLink class="pretty-link" to="https://skullmasher.io">l'administrateur</NuxtLink>.</li>
                </ul>
                <NuxtLink to="https://buy.stripe.com/dR6aG3fIr1zg2Qw7ss" class="btn btn-accent uppercase btn-lg mb-1">Take my money !</NuxtLink>
