...
<template>
  <section class="mb-16 max-w-screen-lg mx-4 lg:mx-auto tracking-wide">
    <h2 class="text-3xl mb-6 font-bold">T-shirt Heartless Gaming logo brodé 100% coton</h2>
    <h3 class="text-2xl font-bold mb-6">Couleurs</h3>
    ...
    <div class="flex items-baseline gap-x-2">
      <h3 class="text-2xl font-bold mb-6">Tailles</h3>
      <span>
        <NuxtLink
        class="pretty-link"
    ...
    <div class="leading-relaxed">
      <p class="font-bold">Information suplémentaires :</p>
      <ul class="list-inside pl-4">
        <li>Broderie sur un <NuxtLink class="pretty-link" to="https://stanleystella.com/fr-fr/creator-2-0-sttu169">T-shirt Stanley/Stella 100% coton biologique vegan</NuxtLink></li>
        <li>Imprimé à la demande (dropshiping) par <NuxtLink to="https://www.printful.com" class="pretty-link">Printful</NuxtLink></li>
